...
const WHATSAPP_URL =
  "https://wa.me/5561982535396?text=" +
  encodeURIComponent("Olá! Recebi uma mensagem e quero verificar a proposta.");

export default function RedirectVerificarProposta() {
  useEffect(() => {
