        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {config.logos.principal ? (
              <img src={config.logos.principal} alt={config.nome} className="h-10 sm:h-12 w-auto max-w-[260px] sm:max-w-[340px] object-contain" />
            ) : (
        ...
        <div className="px-4 py-10" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-center gap-6 sm:gap-10 mb-8">
              ...
              {config.logos.principal ? (
                <img src={config.logos.principal} alt={config.nome} className="h-10 sm:h-12 w-auto max-w-[240px] sm:max-w-[320px] object-contain" />
              ) : (
