...
BEGIN
  ...
  -- Apenas admin pode lançar acordo para CPF que já existe no sistema
  ...
  RAISE EXCEPTION 'Este CPF já possui acordo lançado por % em %. Apenas o administrador pode lançar acordos para CPFs já cadastrados.',
