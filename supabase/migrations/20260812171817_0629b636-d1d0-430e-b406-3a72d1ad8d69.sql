CREATE TABLE public.meta_atendimento_rodizio_estado (
  tenant_id uuid NOT NULL,
  folder_key uuid NOT NULL,
  ultima_ordem integer,
  atualizado_em timestamptz NOT NULL DEFAULT now(),
  PRIMARY KEY (tenant_id, folder_key)
);

GRANT ALL ON public.meta_atendimento_rodizio_estado TO service_role;
ALTER TABLE public.meta_atendimento_rodizio_estado ENABLE ROW LEVEL SECURITY;
