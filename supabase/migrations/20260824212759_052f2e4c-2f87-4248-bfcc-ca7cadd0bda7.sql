SELECT cron.unschedule('objecao-aprender-diario') WHERE EXISTS (SELECT 1 FROM cron.job WHERE jobname = 'objecao-aprender-diario');

SELECT cron.schedule(
  'objecao-aprender-diario',
  '45 6 * * *',
  $$
  SELECT net.http_post(
    url:='https://cymdrkeukockakfzjeen.supabase.co/functions/v1/objecao-aprender',
