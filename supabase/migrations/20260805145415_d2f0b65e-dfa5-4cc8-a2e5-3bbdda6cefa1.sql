...
BEGIN
  ...
  -- Se já enviamos mensagem para este telefone/instância, a conversa foi iniciada por um
  -- atendente nosso: quem decide a etiqueta é o webhook (identifica o iniciador).
  SELECT EXISTS(
