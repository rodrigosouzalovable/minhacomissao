...
export async function verificarLeadsCertificado(service: any, limite = 1000, janela?: number, dataAbertura?: string, preparacaoId?: string, cnaes?: string[]): Promise<Resultado> {
