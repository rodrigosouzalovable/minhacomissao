...
- O erro `#131031` retira somente o número que recebeu a recusa. Outros números GREEN da mesma BM continuam elegíveis e são validados individualmente pela tentativa real de envio.
